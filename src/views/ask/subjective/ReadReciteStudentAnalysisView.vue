  ...
  <div class="full-screen-container">
    <header class="page-header">
      <div class="header-left">
        <div class="logo-badge" aria-hidden="true">{{ modeBadge }}</div>
        <div class="header-text">
          <h1 class="title">{{ pageTitle }} · 学生详情</h1>
        </div>
      </div>
    </header>
    ...
    <div class="page-content">
      <section class="left-main-panel">
        <div class="transcribe-container">
          <h3 class="section-title">
            {{ currentStudent?.name || "" }} 的语音转文本
          </h3>
          <p class="transcribe-text">{{ currentStudent?.text || "" }}</p>

          <OriginalTextComparison :segments="comparisonSegments" />
        </div>
      ...
      <aside class="right-sidebar">
        ...
        <div class="dimensions-card">
          <h3 class="dimensions-title">维度得分</h3>
          <div
          ...
          >
            ...
            <div class="dimension-score">
              ...
              <span class="score-max">/ {{ dimension.max }}</span>
            </div>
          </div>
        </div>
      </aside>
